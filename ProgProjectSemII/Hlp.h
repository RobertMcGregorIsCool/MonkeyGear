...
/// Purpose: Data for helper functions.
...
public:
	...
	static float		randomFloatRange(float min, float max); // Much better float range implementation, credit to Jay on GameMakers Discord.
};
